...
const DetailsBanner = ({ video, crew }) => {
    ...
    useEffect(()=>{
        console.log(url.backdrop, "url");
        console.log(data?.backdrop_path, "dataMe");
        setPoster(url.backdrop+data?.backdrop_path);
        setPosterCard(url.poster+data?.poster_path)
    },[data, url])

    const _genres = data?.genres?.map((g)=> g.id);
    useEffect(()=>{
        console.log(crew, "my Crew");
    },[crew]);
                    ...
                    {!!data && (
                        <React.Fragment>
                                ...
                                <ContentWrapper>
                                        ...
                                        <div className="left">
                                            {data.poster_path ? (
                                                <Img className="posterImg" src={posterCard}></Img>
                                            ):(
